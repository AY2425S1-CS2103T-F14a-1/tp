...
with(this){return _c('ol',[_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("For any simple usage, the application should be able to respond within 2 seconds.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should only be used by one person at a time, meaning it is designed for a single user and cannot be accessed or shared by multiple users simultaneously.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Fri, 27 Sept 2024, 17:17:38 GMT+8]")])])])}
}];
